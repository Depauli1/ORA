 ...
 *
 */
contract StabilityPoolRWA is LiquityBaseRWA, Ownable, CheckContract, IStabilityPool, ICollateralReceiver {
    ...
    * - Updates snapshots for deposit and tagged front end stake */
    function withdrawETHGainToTrove(address _upperHint, address _lowerHint) external override {
        ...
        require(collToken.transfer(address(borrowerOperations), depositorETHGain), "StabilityPool: sending collateral to BorrowerOps failed");
    ...
    */
    ...
    function _sendETHGainToDepositor(uint _amount) internal {
        ...
        require(collToken.transfer(msg.sender, _amount), "StabilityPool: sending collateral failed");
    }
    ...
    // Replaces receive(): called by ActivePool after transferring collateral tokens in.
